            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem; margin-bottom: 2rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        ...
                        <select name="fornisseur_id" id="fornisseur_id" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.5rem; outline: none;">
                            ...
                            @foreach($fornisseurs as $fornisseur)
                                <option value="{{ $fornisseur->id }}" {{ old('fornisseur_id', $product->fornisseur_id) == $fornisseur->id ? 'selected' : '' }}>
                                    {{ $fornisseur->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="purchase_price" id="purchase_price" step="0.01" min="0" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.5rem; outline: none;" placeholder="0.00" value="{{ old('purchase_price', $product->purchase_price) }}">
