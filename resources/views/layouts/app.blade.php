    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a href="{{ route('employes.index') }}" class="nav-item {{ request()->routeIs('employes.*') ? 'active' : '' }}">
                    <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="nav-dropdown {{ request()->routeIs('expenses.*', 'expense-categories.*') ? 'open' : '' }}">
                    <button class="nav-dropdown-trigger {{ request()->routeIs('expenses.*', 'expense-categories.*') ? 'active' : '' }}" type="button" onclick="toggleDropdown(this)">
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="nav-dropdown-content">
                        <a href="{{ route('expenses.index') }}" class="sub-nav-item {{ request()->routeIs('expenses.index') ? 'active' : '' }}">
