            ...
            <div style="margin-bottom: 2rem;">
                ...
                <div class="multi-select-container">
                    ...
                    <div id="hiddenCheckboxes" style="display: none;">
                        <input type="checkbox" name="specialite[]" value="embalage" {{ is_array(old('specialite')) && in_array('embalage', old('specialite')) ? 'checked' : '' }}>
                        <input type="checkbox" name="specialite[]" value="capsule" {{ is_array(old('specialite')) && in_array('capsule', old('specialite')) ? 'checked' : '' }}>
                        <input type="checkbox" name="specialite[]" value="herb" {{ is_array(old('specialite')) && in_array('herb', old('specialite')) ? 'checked' : '' }}>
                    </div>
                </div>
